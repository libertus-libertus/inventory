    ...
    <div class="wrapper">
        <div class="receipt">
            ...
            <div class="line-item">
                ...
                <span class="total">{{ $stockOut->reference_code }}</span>
            </div>
            <div class="line-item">
                <span class="label">Tanggal:</span>
                <span class="total">{{ \Carbon\Carbon::parse($stockOut->stock_out_date)->format('d/m/Y') }}</span>
            </div>
            <div class="line-item">
                <span class="label">User:</span>
                <span class="total">{{ $stockOut->user->name }}</span>
            </div>
            <div class="line-item">
                <span class="label">Pelanggan:</span>
                <span class="total">{{ $stockOut->customer->name ?? 'Pelanggan tidak ditemukan' }}</span>
            </div>
            ...
            <div class="product-detail">
                ...
                <div class="line-item">
                    <span class="qty">{{ $stockOut->quantity }} {{ $stockOut->product->unit }}</span>
