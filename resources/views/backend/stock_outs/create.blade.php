...
@section('content')
    <div class="mb-8">
        ...
        <p class="text-gray-600">Formulir untuk mencatat transaksi barang keluar ke pelanggan.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <form action="{{ route('stock_outs.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Tanggal Transaksi --}}
                <div>
                    <label for="stock_out_date" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Transaksi <span class="text-red-500">*</span></label>
                    <input type="date" name="stock_out_date" id="stock_out_date" required
                        class="mt-1 block w-full px-3 py-2 border rounded-md shadow-sm sm:text-sm @error('stock_out_date') border-red-500 @enderror"
                ...
                {{-- customer --}}
                <div>
                    <label for="customer_id" class="block text-sm font-medium text-gray-700 mb-1">Pelanggan <span class="text-red-500">*</span></label>
                    <select name="customer_id" id="customer_id" required
                        class="mt-1 block w-full px-3 py-2 border bg-white rounded-md shadow-sm sm:text-sm @error('customer_id') border-red-500 @enderror">
